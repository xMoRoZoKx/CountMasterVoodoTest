...
namespace UniTools
{
    public static class GeometryTools
    {
        ...
        public static Vector3 ToLocal(this Vector3 vector, Transform localizator) => localizator.InverseTransformPoint(vector);

        public static SerializableVector3 ToSerializable(this Vector3 vector) => new SerializableVector3(vector);
    }
}