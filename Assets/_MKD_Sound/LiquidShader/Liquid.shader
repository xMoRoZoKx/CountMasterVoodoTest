Shader "Unlit/SpecialFX/Liquid"
{
	...
	_FillAmount("Fill Amount", Range(-10,10)) = 0.0
		...
		_EmissionColor("Emission Color", Color) = (0,0,0,1) // Ajout de la couleur d'émission
		...
		SubShader
	{
			...
			Pass
		{
			...
			float4 _TopColor, _RimColor, _FoamColor, _Tint, _EmissionColor;
			...
			fixed4 frag(v2f i, fixed facing : VFACE) : SV_Target
			{
				...
				fixed4 outputColor = facing > 0 ? finalResult : topColor;

				// add emission
				outputColor.rgb += _EmissionColor.rgb;
